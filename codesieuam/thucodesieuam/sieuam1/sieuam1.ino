...
String GAS_ID = "AKfycbwxdAHh1mKaPloE6cDvkGMDRH_Ud3Fv9ILtw2qo15J_eiLS5OlSJANwa8EwnMkTd5Lxxg"; //--> spreadsheet script ID
...
void update_google_sheet()
{
    ...
    String url = "/macros/s/" + GAS_ID + "/exec?songuoitrongphong=";
   
    url += String(songuoitrongphong);
